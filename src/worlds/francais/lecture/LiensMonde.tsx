  ...
  return (
    <div className="min-h-screen bg-[url('/src/assets/bg-foret-pastel.png')] bg-cover bg-center font-glacial text-loma-brun p-8">
      <header className="max-w-5xl mx-auto pt-10 text-center">
        <h1 className="text-5xl font-semibold text-loma-brun drop-shadow-sm">🔗 Monde des Liens</h1>
        <p className="mt-3 text-loma-violet">Relie les idées, les mots et les histoires entre eux...</p>
      </header>

      <main className="max-w-5xl mx-auto py-8">
        <div className="rounded-3xl bg-white/90 backdrop-blur-sm shadow-loma border border-loma-brun/30 p-6">
          <ExerciseEngine domaine="lecture-liens" exercices={exercices} />
        </div>
        <div className="mt-8 text-center">
          <Link to="/francais/lecture"
            className="px-8 py-4 rounded-xl bg-loma-brun text-loma-beige font-semibold hover:brightness-105 shadow-lomaHover transition">
